import { Questions } from '@stypes/questions';

const data: Array<Questions> = [
  {
    text: "You're really busy at work and a colleague is telling you their life story and personal woes. You:",
    answers: [
      { text: "Don't dare to interrupt them", value: 1 },
      {
        text: "Think it's more important to giive them some fo your time; work can wait",
        value: 2,
      },
      { text: 'Listen, but with only with half an ear', value: 3 },
      {
  ...
  },
  {
    ...
    answers: [
      { text: 'Look at your watch every two minutes', value: 1 },
      { text: 'Bubble with inner anger, but keep quiet', value: 2 },
      {
  ...
  },
  {
    ...
    answers: [
      { text: 'Don’t dare contradict them', value: 1 },
      { text: 'Think that they are obviously right', value: 2 },
      { text: 'Defend your own point of view, tooth and nail', value: 3 },
      { text: 'Continuously interrupt your colleague', value: 4 },
    ],
  },
  {
    ...
    answers: [
      ...
      { text: 'Follow the group without question', value: 2 },
      {
  ...
  },
  {
    ...
    answers: [
      ...
      { text: 'Talk privately between themselves', value: 2 },
      { text: 'Hang around you all evening', value: 3 },
      {
  ...
  },
  {
    ...
    answers: [
      ...
      { text: 'Wait to share it with your friends after work', value: 2 },
      {
        text: 'Try again a bit later with one of your colleagues',
        value: 3,
      },
      { text: 'Keep telling it until they pay attention', value: 4 },
    ],
  },
  {
    text: 'During dinner parties at your home, you have a hard time with people who:',
